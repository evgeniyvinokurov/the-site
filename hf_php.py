...
refaqfilemain = "./php/faq/index.html" 
...
projects = [
    {"name": "deezer-api-albums-php", "files": [], "url": "/albums/"},
    {"name": "get-your-song", "files": [], "url": "/get-your-song/"},
    {"name": "api-calls", "files": [], "url": "/api-calls/"}
]
...
for p in projects: 
    ...
    os.makedirs(os.path.dirname(newimgfile), exist_ok=True)
...
preimgindexfile = "./php/index.html"
